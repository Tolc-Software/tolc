...
# Downloads the boost project either from VERSION - version of boost used
# Variables exported: boost_SOURCE_DIR
function(get_boost)
  ...
  # Boost include directory should now be available as boost_SOURCE_DIR Export
  # the variables
  message(STATUS "Exporting variables")
...
# Links input TARGET to the boost downloaded from get_boost Expects
# boost_SOURCE_DIR to be available
function(target_link_boost)
  ...
  if(NOT boost_SOURCE_DIR)
    message(
      FATAL_ERROR
        "Called target_link_boost without boost_SOURCE_DIR having a VALUE. Did you call get_boost before this function."
    )
  endif()
