...
function(copy_llvm_includes)
  ...
  set(prefix ARG)
  set(noValues)
  set(singleValues LLVM_DIR LLVM_MAJOR_VERSION OUTPUT_DIR)
  set(multiValues)
  # Process the arguments passed in can be used e.g. via ARG_TARGET_DIR
  ...
  if(NOT ARG_LLVM_MAJOR_VERSION)
    message(FATAL_ERROR "No LLVM major version specified.")
  endif()
  ...
  foreach(includeDir
          ${ARG_LLVM_DIR}/include
          ${ARG_LLVM_DIR}/lib/clang/${ARG_LLVM_MAJOR_VERSION}/include)
    # Get the directory path that should hold the include files
    string(REPLACE "${ARG_LLVM_DIR}" "" relativeDir ${includeDir})
    message(STATUS "Copying ${includeDir} to ${ARG_OUTPUT_DIR}/${relativeDir}")
