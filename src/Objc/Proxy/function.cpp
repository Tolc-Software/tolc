  ...
  std::transform(arguments.begin(),
                 ...
                 [&](auto const& argument) {
                   return ObjcSwift::Helpers::wrapInFunction(
                       argument.m_name, argument.m_type.m_conversions.m_toCpp);
                 });
...
Function::Function(std::string const& name,
  ...
  : m_name(name), m_cppName(cppName), m_fullyQualifiedName(fullyQualifiedName),
    m_objcClass(objcClass), m_cppClass(cppClass), m_documentation(),
    m_returnType(), m_overloadedIndex(std::nullopt), m_isStatic(false),
