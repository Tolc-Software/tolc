...
void valueConversion(IR::Type const& type,
  ...
  switch (baseType) {
    ...
    case BaseType::UnsignedChar: {
      convertNSNumber(type, "unsigned char", "UnsignedChar", functions, cache);
      break;
    }
    case BaseType::UnsignedInt: {
      convertNSNumber(type, "unsigned int", "UnsignedInt", functions, cache);
      break;
    }
    case BaseType::UnsignedLongInt: {
      convertNSNumber(type, "unsigned long", "UnsignedLong", functions, cache);
      break;
    }
    case BaseType::UnsignedLongLongInt: {
      convertNSNumber(
          type, "unsigned long long", "UnsignedLongLong", functions, cache);
      break;
    }
